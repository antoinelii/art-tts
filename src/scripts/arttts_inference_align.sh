#!/bin/bash
#SBATCH --job-name=arttts_align     # Job name
...
#                                    --save_dir ${MAIN_DATA_DIR}/LJSpeech-1.1/arttts_align/v1/${CKPT_NAME} \
...
srun python -u ./arttts_inference.py  --data_dir ${MAIN_DATA_DIR} \
                                    --save_dir ${MAIN_DATA_DIR}/$DATASET/arttts/$SPK/arttts_align/v1/${CKPT_NAME} \
