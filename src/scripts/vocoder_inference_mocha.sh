...
for E in 2000 4000 6000 8000 10000; do
    ...
    for MODEL_VERSION in v2_full; do
        ...
        if [ "$DATASET" = "LJSpeech-1.1" ]; then
            ...
            srun python -u ./vocoder_inference.py  --data_dir ${MAIN_DATA_DIR}/LJSpeech-1.1/arttts_pred/${MODEL_VERSION}/${CKPT_NAME} \
            ...
            srun python -u ./vocoder_inference.py  --data_dir ${MAIN_DATA_DIR}/$DATASET/arttts/$SPK/arttts_pred/${MODEL_VERSION}/${CKPT_NAME} \
