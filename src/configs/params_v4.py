...
train_filelist_path = "resources/filelists/ljspeech/train_v4.txt"
valid_filelist_path = "resources/filelists/ljspeech/valid_v4.txt"
test_filelist_path = "resources/filelists/ljspeech/test_v4.txt"
