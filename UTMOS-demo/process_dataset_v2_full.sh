...
for dataset in LJSpeech-1.1 MNGU0 mocha_timit MSPKA_EMA_ita; do
	for E in 2000 4000 6000 8000 10000; do
		CKPT_NAME=grad_${E}
		utmos_version_dir=${MAIN_DATA_DIR}/${dataset}/UTMOS_data/decoder_files_v2_full/${CKPT_NAME}
		mkdir -p  ${utmos_version_dir}
		find ${MAIN_DATA_DIR}/${dataset} -type f -path "*/hifigan_pred/v2_full/${CKPT_NAME}/*_decoder.wav" \
