...
for E in 3000 4000; do
    ...
    for MODEL_VERSION in msml1h; do
        ...
        for LANG in  ja ba ro hi uz tt el sr mt yo be uk hy-AM sk ckb tr vi bg ta sv-SE id tk kmr dv zh-HK bn mn zh-CN yue lij fr hsb cv nl ug mr it lt sl pa-IN ru cs ml nan-tw th pt ky pl ca hu rw; do
            ...
            srun python -u ./scripts/inference/hifigan_inference_ms.py  --data_dir ${MAIN_DATA_DIR}/${DATASET}/${SPLIT}/arttts_pred/${MODEL_VERSION}/${CKPT_NAME} \
            ...
            #srun python -u ./scripts/inference/hifigan_inference_ms.py  --data_dir ${MAIN_DATA_DIR}/${DATASET}/encoded_audio_multi/${LANG}/emasrc \
