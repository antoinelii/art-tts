...
for dataset in MNGU0 MSPKA_EMA_ita mocha_timit pb2007; do
    srun python -u ./scripts/inference/encode_audio_voxcom.py --device cuda \
                                    --manifest_fp ${MAIN_DATA_DIR}/VoxCommunis/${dataset}/manifests/${dataset}.tsv \
